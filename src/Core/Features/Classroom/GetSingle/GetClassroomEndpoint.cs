...
public class GetClassroomEndpoint(
    ILogger<GetClassroomEndpoint> logger,
    ApplicationDbContext dbContext
) : Endpoint<GetClassroomRequest, GetClassroomResponse, GetClassroomMapper>
{
    public override async Task HandleAsync(GetClassroomRequest req, CancellationToken ct)
    {
        ...
        await SendMapped(classroom, ct: ct);
    }
}
