...
public class GetCourseEndpoint(ILogger<GetCourseEndpoint> logger, ApplicationDbContext dbContext)
    : Endpoint<GetCourseRequest, GetCourseResponse, GetCourseMapper>
{
